import { pgTable, uuid, varchar, timestamp, json, boolean, text ,smallint,pgSchema} from "drizzle-orm/pg-core";
...
export const authUsers =  authSchema.table("users", {
    ...
    email_change_token_current: varchar("email_change_token_current", { length: 255 }),
